...
export type CountriesQuery = { __typename?: 'Query', countries: Array<{ __typename?: 'Country', name: string, emoji: string, code: string, id: number }> };
...
export type GetCountryByIdQuery = { __typename?: 'Query', country: { __typename?: 'Country', name: string, emoji: string, continent?: { __typename?: 'Continent', name: string } | null } };
